...
{
private:
    bool init(const char *spriteName, cocos2d::CCObject *target, cocos2d::SEL_MenuHandler callback)
    {
        if (!CCLayer::init())
        {
            return false;
...
public:
    static FanmadeGamesCell *create(const char *p0, cocos2d::CCObject *p1, cocos2d::SEL_MenuHandler p2)
    {

#include "EndCreditsNode.hpp"

bool EndCreditsNode::init(const char *name, int accountID, int iconID, int color1, int color2, int color3)
{
    if (!CCNode::init())
        return false;
...
EndCreditsNode *EndCreditsNode::create(const char *name, int accountID, int iconID, int color1, int color2, int color3)
{

...
{
private:
    void setupCreditsManagers();
    void setupCreditsModders();
    void setupCreditsCreatorsOne();
    void setupCreditsCreatorsTwo();
    void setupCreditsArtists();
    void setupCreditsTestersOne();
    void setupCreditsTestersTwo();
    void setupCreditsSpecials();

    CCLayer *createCredits(int list, const char *reason);

protected:
    CCScale9Sprite *m_background = nullptr;
    CCScale9Sprite *m_middleground = nullptr;

    CCMenuItemSpriteExtra *m_prevBtn = nullptr;
    CCMenuItemSpriteExtra *m_nextBtn = nullptr;

    CCLayer *m_creditsManagersLayer = nullptr;
    CCLayer *m_creditsModdersLayer = nullptr;
    CCLayer *m_creditsCreatorsLayerOne = nullptr;
    CCLayer *m_creditsCreatorsLayerTwo = nullptr;
    CCLayer *m_creditsArtistsLayer = nullptr;
    CCLayer *m_creditsTestersLayerOne = nullptr;
    CCLayer *m_creditsTestersLayerTwo = nullptr;
    CCLayer *m_creditsSpecialsLayer = nullptr;
...
const std::vector<std::vector<gd::string>> creditsTestersOne = {
